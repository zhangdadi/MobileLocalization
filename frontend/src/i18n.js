...
const messages = {
  en: {
    ...
    upload: {
      ...
      edit: 'Edit',
      download: 'Download',
      editDialogTitle: 'Edit File: {name}',
      appendDialogTitle: 'Append Content: {name}',
      loadingFileContent: 'Loading file content...',
      editPlaceholder: 'Edit file content here',
      appendPlaceholder: 'Paste new iOS/Android entries here',
      appendTip: 'Format must match the selected platform. New keys will be appended to the bottom and synced to other languages on this platform.',
      appendExampleIos: '"or_continue_with" = "Or continue with";\n"register_now" = "Register now";',
      appendExampleAndroid: '<string name="select_bottle_type">Choose the type of expression you want</string>\n<string name="close">Close</string>',
      copy: 'Copy',
      cancelEdit: 'Cancel',
      saveEdit: 'Save',
      appendSave: 'Append & Sync',
      savingFileContent: 'Saving...',
      appendingContent: 'Appending...',
      ...
      toastReadFileFailed: 'Failed to read file content',
      toastSaveFileSuccess: 'File saved successfully',
      toastSaveFileFailed: 'Failed to save file',
      toastAppendSuccess: 'Appended successfully: {added} new keys, {updated} updated keys',
      toastAppendFailed: 'Failed to append content',
      toastCopySuccess: 'Content copied',
    ...
    editor: {
      ...
      searchByEnglish: 'Search by English value',
      refresh: 'Refresh',
      addKey: 'Add key',
      columnKey: 'Key',
  ...
  zh: {
    ...
    upload: {
      ...
      edit: '编辑',
      download: '下载',
      editDialogTitle: '编辑文件：{name}',
      appendDialogTitle: '追加内容：{name}',
      loadingFileContent: '正在加载文件内容...',
      editPlaceholder: '在这里编辑文件内容',
      appendPlaceholder: '在这里粘贴新增的 iOS/Android 文本条目',
      appendTip: '内容格式必须与当前平台一致。新增 key 会追加到底部，并自动同步到本平台其它语种。',
      appendExampleIos: '"or_continue_with" = "Or continue with";\n"register_now" = "Register now";',
      appendExampleAndroid: '<string name="select_bottle_type">Choose the type of expression you want</string>\n<string name="close">Close</string>',
      copy: '复制',
      cancelEdit: '取消',
      saveEdit: '保存',
      appendSave: '追加并同步',
      savingFileContent: '保存中...',
      appendingContent: '追加中...',
      languageEnglish: '英语',
      languageArabic: '阿拉伯语',
      ...
      toastReadFileFailed: '读取文件内容失败',
      toastSaveFileSuccess: '文件保存成功',
      toastSaveFileFailed: '文件保存失败',
      toastAppendSuccess: '追加成功：新增 {added} 个 key，更新 {updated} 个 key',
      toastAppendFailed: '追加内容失败',
      toastCopySuccess: '已复制内容',
